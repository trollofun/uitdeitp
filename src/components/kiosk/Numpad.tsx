    ...
    <div className="grid grid-cols-3 gap-3 w-full max-w-[320px] mx-auto">
      ...
      {numbers.map((num) => (
        <motion.button
          ...
          className="h-24 text-2xl font-medium bg-white/80 backdrop-blur shadow-sm rounded-xl hover:bg-white/90 transition-colors active:shadow-inner"
      ...
      <motion.button
        ...
        onClick={onDelete}
        className="h-24 flex items-center justify-center bg-red-50/80 backdrop-blur shadow-sm rounded-xl hover:bg-red-100/90 transition-colors active:shadow-inner"
        aria-label="Delete"
      >
