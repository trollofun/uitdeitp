...
4. **Configure Cron Job**: See [Vercel Cron Jobs](#vercel-cron-jobs)
...
| `CRON_SECRET` | Security key for cron endpoints | tOcDZJ7... |
...
- [**CLAUDE.md**](./CLAUDE.md) - SPARC development environment
